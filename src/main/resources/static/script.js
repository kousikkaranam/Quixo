...
//                 // It's a file: redirect to download
...
//         })
//         .then((data) => {
//             // If the data object is empty, do nothing.
//             if (Object.keys(data).length === 0) return;
//
//             // Get text content; if blank, set a default message.
//             let textContent = data.text ? data.text.trim() : "";
//             if (textContent === "") {
//                 textContent = "api has retrieved/code only";
//             }
//
//             // Open a new tab and write the text with proper styling.
